...
export default function Features() {
            ...
            <div className="max-w-[1180px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    {features.slice(0, 3).map((feature, index) => (
                        <div
                            key={index}
                            className="bg-[#fafafa] border border-[#efefef] rounded-[28px] px-7 pt-7 overflow-hidden min-h-[320px] flex flex-col"
                        >
                            <div>
    ...
    `}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Secure Syncing */}
                    <div className="bg-[#fafafa] border border-[#efefef] rounded-[28px] px-7 py-7 overflow-hidden min-h-[250px]">
