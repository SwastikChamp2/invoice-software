        ...
        <section className="bg-white py-24 px-5 md:px-8 overflow-hidden">
            <div className="max-w-[1220px] mx-auto">
                ...
                <div className="flex items-start justify-between gap-8 mb-14">
                    ...
                    <button className="hidden md:flex h-[46px] px-5 rounded-full border border-[#ececec] bg-white items-center justify-center text-[15px] font-medium text-[#111111] shadow-[0_4px_10px_rgba(0,0,0,0.04)] hover:bg-[#fafafa] transition-all">
                        Leave a review
                    </button>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="flex items-center justify-center gap-3 mt-8">
                        <button
                            onClick={prevSlide}
                            className="w-10 h-10 rounded-full border border-[#ececec] bg-white flex items-center justify-center shadow-sm hover:bg-[#fafafa] transition-all"
                        >
                        ...
                        <div className="flex gap-2">
                            {testimonials.map((_, i) => (
                                <button
                                    key={i}
                                    onClick={() => setActive(i)}
                                    className={`h-[6px] rounded-full transition-all duration-300 ${active === i
                                        ? 'w-8 bg-[#111111]'
                                        : 'w-2 bg-[#d6d6d6]'
                                        }`}
                                />
